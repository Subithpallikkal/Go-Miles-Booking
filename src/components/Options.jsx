  ...
  return (
    ...
    >
      {options.map((option, i) => {
        const isSelected = selectedOptions[question.name] === option.option
        ...
        if (!option.image) {
          return (
            <div
              ...
              className={`border rounded-md flex text-white font-bold bg-theme items-center justify-center h-10 ${
